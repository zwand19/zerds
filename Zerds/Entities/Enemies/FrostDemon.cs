...
namespace Zerds.Entities.Enemies
{
    public class FrostDemon : Enemy
    {
        ...
        {
            _ai = new RangeAI(this, new RangeAttack(this, 14, 17, MissileTypes.FrostDemonMissile, AbilityConstants.FrostDemonMissileCooldown));

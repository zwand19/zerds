...
namespace Zerds.GameObjects
{
    public class PlayerSkills
    {
        ...
        public PlayerSkills(PlayerIndex playerIndex)
        {
            ...
            var replenish = new SkillTreeItem(SkillConstants.ReplenishName, $"Wand attacks restore {StatStr(SkillConstants.ReplenishStat, 5, 1)}% of your mana.", 5, 1, 0, "Icons/potion-ball.png", improvedWand);
            ArcaneSkillTree.Items.Add(replenish);
            var sprinter = new SkillTreeItem(SkillConstants.SprinterName, $"Reduces mana cost of sprint by {StatStr(SkillConstants.SprintStat, 5, 3)}%.", 5, 1, 4, "Icons/rabbit.png", swift);
